 ...
 * File Built by Zen Cart Installer on Thu Apr 02 2020 15:36:22
 */
 ...
 */
define('HTTP_SERVER', 'http://localhost:8097');
define('HTTPS_SERVER', 'https://localhost:8097');
...
define('DB_SERVER', $dbhost);  // address of your db server
define('DB_SERVER_USERNAME', $dbuser);
define('DB_SERVER_PASSWORD', $dbpass);
define('DB_DATABASE', $dbname);

/**
 * Admin password expires after 100 years
 */
